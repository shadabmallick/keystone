...
public class UsefullinkAdapter extends RecyclerView.Adapter<UsefullinkAdapter.GroceryViewHolder>{
    private List<News> horizontalGrocderyList;
    Context context;

    public UsefullinkAdapter(List<News> horizontalGrocderyList, Context context){
    ...
    public GroceryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View groceryProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_useful_link, parent, false);
