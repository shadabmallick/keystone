...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.GroceryViewHolder>{
   // public List<News> horizontalGrocderyList;
    ...
    public NewsAdapter( ArrayList<HashMap<String,String>> horizontalGrocderyList,ArrayList<HashMap<String,String>> Array_category, Context context){
    ...
    public void onBindViewHolder(GroceryViewHolder holder, final int position) {
        ...
        if (Array_category.get(position).get("name").equals("Featured")) {
