...
public class OnTheAirAdapter extends RecyclerView.Adapter<OnTheAirAdapter.GroceryViewHolder>{
    private List<OnTheAirModel> horizontalGrocderyList;
    Context context;

    public OnTheAirAdapter(List<OnTheAirModel> horizontalGrocderyList, Context context){
    ...
    public GroceryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View groceryProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.on_the_air_single, parent, false);
