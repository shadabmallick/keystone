...
public class SingleEventAdapter extends RecyclerView.Adapter<SingleEventAdapter.GroceryViewHolder>{
    private List<EventDetails> horizontalGrocderyList;
    Context context;

    public SingleEventAdapter(List<EventDetails> horizontalGrocderyList, Context context){
    ...
    public GroceryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View groceryProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_events_detaisl, parent, false);
