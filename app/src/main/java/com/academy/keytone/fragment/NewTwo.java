...
import com.academy.keytone.adapter.AcademicAdapter;
...
public class NewTwo extends Fragment {
    View view;
    TextView textView5;
    ...
    private AcademicAdapter groceryAdapter;
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if(status.equals("1") ) {
                        ...
                        groceryAdapter = new AcademicAdapter(Array_news_list,Array_category, getActivity());
                        recyclerView.setAdapter(groceryAdapter);
